...
// imdCapIngest.js, mastodonIngest.js, plus the citizen report route) calls
// getProducer() from here instead of building its own kafkajs Kafka()
// instance, and the consumer (server/worker.js) calls createConsumer().
//
